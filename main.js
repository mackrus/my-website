...
moonMesh.position.set(0.3, 0, 0); // Relative to Earth
...
const earthOrbit = {
  semiMajorAxis: 3.75,
  eccentricity: 0.0167,
  orbitalPeriod: 0.25 / orbitalSpeed,
};
...
function moveCamera() {
  ...
  const distance = 3 * sun.geometry.parameters.radius;

  // Calculate the angle based on the scroll position
  const angle = move * 0.001;
